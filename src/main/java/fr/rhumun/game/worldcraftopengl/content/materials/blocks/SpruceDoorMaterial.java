...
public class SpruceDoorMaterial extends Material implements PlaceableMaterial, ForcedModelMaterial, InteractableMaterial, Multiblock, RotableMaterial {
    public SpruceDoorMaterial() {
        super(Texture.SPRUCE_DOOR);
    }
