...
public class CherryLogMaterial extends Material implements PlaceableMaterial {
    public CherryLogMaterial() {
        super(Texture.CHERRY_LOG);
        this.addToType(GuiTypes.NATURAL);
        this.setTopAndBottomTexture(Texture.CHERRY_LOG_TOP);
    }
