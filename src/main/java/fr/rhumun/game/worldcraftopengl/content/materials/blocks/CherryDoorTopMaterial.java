...
public class CherryDoorTopMaterial extends Material implements PlaceableMaterial, ForcedModelMaterial, InteractableMaterial, Multiblock, RotableMaterial {

    public CherryDoorTopMaterial() {
        super(Texture.CHERRY_DOOR_TOP);
    }
    ...
    public void onPlace(Block block) {
        ...
        if (up != null && up.getMaterial() == null) {
            up.setModel(block.getModel()).setMaterial(Materials.CHERRY_DOOR).setState(block.getState());
        }
    }
