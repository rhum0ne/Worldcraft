...
public class SpruceDoorTopMaterial extends Material implements PlaceableMaterial, ForcedModelMaterial, InteractableMaterial, Multiblock, RotableMaterial {

    public SpruceDoorTopMaterial() {
        super(Texture.SPRUCE_DOOR_TOP);
    }
    ...
    public void onPlace(Block block) {
        ...
        if (up != null && up.getMaterial() == null) {
            up.setModel(block.getModel()).setMaterial(Materials.SPRUCE_DOOR).setState(block.getState());
        }
    }
