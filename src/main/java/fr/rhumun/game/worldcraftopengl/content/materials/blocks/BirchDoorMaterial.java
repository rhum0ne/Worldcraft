...
public class BirchDoorMaterial  extends Material implements PlaceableMaterial, ForcedModelMaterial, InteractableMaterial, Multiblock, RotableMaterial {
    public BirchDoorMaterial() {
        super(Texture.BIRCH_DOOR);
    }
    ...
    public void onPlace(Block block) {
        Block up = block.getBlockAtUp();
        if (up != null && up.getMaterial() == null) {
            up.setModel(block.getModel()).setMaterial(Materials.BIRCH_DOOR_TOP).setState(block.getState());
        }
    }
