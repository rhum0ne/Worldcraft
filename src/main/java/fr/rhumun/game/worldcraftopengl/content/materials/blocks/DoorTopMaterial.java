...
public class DoorTopMaterial extends Material implements PlaceableMaterial, ForcedModelMaterial, InteractableMaterial, Multiblock, RotableMaterial {

    public DoorTopMaterial() {
        super(Texture.DOOR_TOP);
    }
    ...
    public void onPlace(Block block) {
        ...
        if (up != null && up.getMaterial() == null) {
            up.setModel(block.getModel()).setMaterial(Materials.DOOR).setState(block.getState());
        }
    }
