...
public class TreeStructure extends AbstractStructure{
    ...
    public void buildAt(World world, int x, int y, int z) {
        ...
        world.getBlockAt(x, h++ ,z, true).setMaterial(Materials.LOG).setModel(Model.CYLINDER);
        world.getBlockAt(x, h++ ,z, true).setMaterial(Materials.LOG).setModel(Model.CYLINDER);
        world.getBlockAt(x, h++ ,z, true).setMaterial(Materials.LOG).setModel(Model.CYLINDER);
        world.getBlockAt(x, h++ ,z, true).setMaterial(Materials.LOG).setModel(Model.CYLINDER);
        world.getBlockAt(x, h++ ,z, true).setMaterial(Materials.LOG).setModel(Model.CYLINDER);
        if(z%3==0) world.getBlockAt(x, h++ ,z, true).setMaterial(Materials.LOG).setModel(Model.CYLINDER);
        else if(x%5==0) {
            world.getBlockAt(x, h++, z, true).setMaterial(Materials.LOG).setModel(Model.CYLINDER);
            world.getBlockAt(x, h++, z, true).setMaterial(Materials.LOG).setModel(Model.CYLINDER);
        }
